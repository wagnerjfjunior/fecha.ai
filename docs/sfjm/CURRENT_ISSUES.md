...
| STS-RESIDUAL-M3-02-SUPPORT | RESIDUAL | STS-M3-02 / STS-M3-05 / STS-M3-06 | NOT_IMPLEMENTED | NO | exceptional root tenant support | `docs/security/evidence/2026-09-08-sts-m3-02-authority-contract-by-context.md` | separately design/implement bounded audited support context and independently validate it | RESIDUAL_RISKS |
