...
--
-- Scope:
-- 1. Remove anonymous access from sensitive operational tables/views.
...
-- - It intentionally does NOT modify parser, financial engine, Worker/Make/n8n flows, or business rules.
