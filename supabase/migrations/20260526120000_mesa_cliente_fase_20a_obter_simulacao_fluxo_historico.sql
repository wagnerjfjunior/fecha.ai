-- FECH.AI / MesaCliente
-- Fase 20A — Reabrir Fluxo pelo Histórico
-- RPC read-only para obter simulação salva e fluxo persistido.
-- Não executa DML financeiro, não altera agenda, parser, Worker/Make ou motor financeiro.
