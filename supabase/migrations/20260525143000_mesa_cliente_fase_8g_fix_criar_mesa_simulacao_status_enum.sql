...
-- Objetivo: corrigir atribuição de status para enum public.mesa_simulacao_status.
-- Escopo: somente CREATE OR REPLACE FUNCTION public.criar_mesa_simulacao.
-- Não altera tabelas, enums, RLS, policies, grants, parser, Worker, Make/n8n ou motor financeiro.
