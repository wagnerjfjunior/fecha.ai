            ...
            <div style={{background:DARK.card,borderRadius:16,padding:16,border:`1px solid ${DARK.border}`}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:12,marginBottom:14}}>
                <div>
                  ...
                  <p style={{color:DARK.muted,fontSize:11,margin:0}}>Ranking compacto por visitas, taxa de contato e volume trabalhado</p>
                </div>
              ...
              {corretores.length>10&&(
                <p style={{color:DARK.muted,fontSize:10,margin:"10px 0 0",textAlign:"center"}}>
                  Exibindo top 10 de {corretores.length} corretores. Ordenação: visitas → taxa contato → trabalhados.
                </p>
              )}
            </div>
          );
